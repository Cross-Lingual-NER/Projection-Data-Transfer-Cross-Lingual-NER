...
python -m src.models.ner.run_ner "${@:2}"
...
# --model_name_or_path FacebookAI/xlm-roberta-large-finetuned-conll03-english \
# --train_dataset_path ./europarl_ner_en_train_ds \
# --output_dir conll2003/xlm_roberta_large_europarl \
# --return_entity_level_metrics \
# --do_train --fp16 --num_train_epochs 10 --gradient_accumulation_steps 4 \
# --auto_find_batch_size \
# --save_strategy epoch \
